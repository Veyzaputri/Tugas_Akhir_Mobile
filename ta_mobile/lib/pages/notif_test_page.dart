...
class NotificationController {
  ...
  static Future<void> onActionReceivedImplementationMethod(
    ...
    MentalCareApp.navigatorKey.currentState?.pushNamedAndRemoveUntil(
      '/notification-page',
  ...
  static Future<bool> displayNotificationRationale() async {
    ...
    BuildContext context = MentalCareApp.navigatorKey.currentContext!;
    await showDialog(
      context: context,
  ...
  static Future<void> scheduleNewNotification({
    ...
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        channelKey:
            'alerts', // pastikan channelKey sesuai yang sudah diinisialisasi
        title: title,
        body: '$username, $msg',
      ...
      actionButtons: [
        NotificationActionButton(key: 'NOW', label: 'Sekarang'),
        NotificationActionButton(key: 'LATER', label: 'Nanti'),
      ],
    );
  }
